{
    ...
    pfile[2] = new TFile("basicplotsv7_neut540_card_5.4.0_nd5_C_1p1hCCQE_1piRS.root","READ");*/
     ...
     pfile[1] = new TFile("basicplotsv8_neut540_card_5.3.6_nd5_C_1p1hCCQE_ccqemec_binE22.root","READ");
     pfile[2] = new TFile("basicplotsv8_neut540_card_5.3.6_nd5_C_1p1hCCQE_ccqemec_binE28.root","READ");*/
    
    pfile[0] = new TFile("basicplotsv8_neut540_card_5.3.6_nd5_C_GFGCCQE_ccqemec.root","READ");
    pfile[1] = new TFile("basicplotsv8_neut540_card_5.3.6_nd5_C_GFGCCQE_ccqemec_binE15.root","READ");
    pfile[2] = new TFile("basicplotsv8_neut540_card_5.3.6_nd5_C_GFGCCQE_ccqemec_binE35.root","READ");
    ...
    //char *model_name[NMODEL2COMP]={"1p1h-E_{b}=25 MeV\0" ,"1p1h-E_{b}=22 MeV\0", "1p1h-E_{b}=28 MeV\0" };
    char *model_name[NMODEL2COMP]={"GFG-E_{b}=25 MeV\0" ,"GFG-E_{b}=15 MeV\0", "GFG-E_{b}=35 MeV\0" };
    ...
    for ( int ivar = 0 ; ivar < NVAR2PLOT ; ivar++ ){
        ...
        h_1d_comprat[0][ivar]->GetYaxis()->SetRangeUser(0.9,1.1);
        for ( int ifile = 1 ; ifile < NMODEL2COMP ; ifile++ ){
            h_1d_comprat[ifile][ivar]->Draw("hist same");
        }
        
        c1->Print(Form("plots/%s_%s_%s_%s_gfgEb.eps",neutversion_s.Data(),flavor_str[flavorindex],hist_type[hist_index[ivar]],hist_kind[topoindex]));
