...
void read_xsec_ccnc_1p1hvssf(){
    ...
    for (Int_t ichan=0; ichan<NCHANNEL; ++ichan) {
        ...
        cout<<"channel "<<ichan<<" inte "<<hxsec[ichan]->Integral()<<" file2 "<<h2xsec[ichan]->Integral()<<endl;
    }
    ...
    for (Int_t ichan=0; ichan<NCHAN4SHOWCC; ++ichan) {
        h2xsec4show[ichan]->Draw("hist same");
    }
