{
    ...
    pfile[0] = new TFile("basicplotsv8add_neut540_card_5.3.6_nd2_C_1p1hCCQE_dis.root","READ");
    pfile[1] = new TFile("basicplotsv8add_neut532_card_5.3.6_nd2_C_GFGCCQE_dis.root","READ");
