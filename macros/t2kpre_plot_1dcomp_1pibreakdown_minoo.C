{
    ...
    TFile *pfile[NMODEL2COMP];
     ...
     TString neutversion_s = "neut542_minoo";
     pfile[0] = new TFile("basicplotsv8add_neut542_card_5.3.6_nd5_C_GFGCCQE_1pi.root","READ");
    //pfile[0] = new TFile("basicplotsv8_neut540_card_5.3.6_nd5_C_GFGCCQE_1piRS.root","READ");
    pfile[1] = new TFile("basicplotsv8add_neut542_card_5.3.6_nd5_C_GFGCCQE_1piRS.root","READ");
    //pfile[1] = new TFile("basicplotsv8_neut540_card_5.3.6_nd5_C_1p1hCCQE_1pi.root","READ");
     pfile[2] = new TFile("basicplotsv8add_neut542_card_5.3.6_nd5_C_GFGCCQE_minoo_1pi.root","READ");
    
     char *int_name[]={"CC 1#pi all\0","#nu_{#mu}+p #rightarrow #mu^{-} + p +#pi^{+}\0" ,"#nu_{#mu}+n #rightarrow #mu^{-} + p +#pi^{0}\0", "#nu_{#mu}+n #rightarrow #mu^{-} + n +#pi^{+}\0" };
    ...
    char *model_name[NMODEL2COMP]={"Graczyk-Sobczyk\0" ,"Rein-Seghal\0", "MK\0" };
    ...
    int topoindex = 10;//5: CC1pi; 8: res11, 9: res12, 10 res14
    //no of pion
    ...
    for ( int ivar = 0 ; ivar < NVAR2PLOT ; ivar++ ){
        ...
        leg0->SetTextSize(18);
        leg0->SetTextFont(43);
        leg0->AddEntry((TObject*)0,int_name[topoindex-7],"");
