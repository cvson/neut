{
    ...
    /*TString neutversion_s = "neut532vs540_1piGSgfg";
    pfile[0] = new TFile("basicplotsv8add_neut540_card_5.3.6_nd5_C_GFGCCQE_1pi.root","READ");
    pfile[1] = new TFile("basicplotsv8add_neut532_card_5.3.6_nd5_C_GFGCCQE_1pi.root","READ");*/
    
    TString neutversion_s = "neut532vs540_1piRSgfg";
    pfile[0] = new TFile("basicplotsv8_neut540_card_5.3.6_nd5_C_GFGCCQE_1piRS.root","READ");
    pfile[1] = new TFile("basicplotsv8_neut532_card_5.3.6_nd5_C_GFGCCQE_1piRS.root","READ");

    //pfile[0] = new TFile("basicplotsv8add_neut540_card_5.3.6_nd5_C_GFGCCQE_1pi.root","READ");
    /*TString neutversion_s = "tmp_neut532vs540_1piGSgfg";
    pfile[0] = new TFile("basicplotsv8add_neut532_card_5.3.6_nd5_C_GFGCCQE_1pi_fixfz.root","READ");
    pfile[1] = new TFile("neutvecv532_card_5.3.6_nd5_C_GFGCCQE_1pi_fixfz_test.root","READ");*/
    ...
    char *model_name[NMODEL2COMP]={"RS - v5.4.0\0" ,"RS - v5.3.2\0"};
    ...
    for ( int ivar = 0 ; ivar < NVAR2PLOT ; ivar++ ){
        ...
        c1->Print(Form("plots/%s_%s_%s_%s.eps",neutversion_s.Data(),flavor_str[flavorindex],hist_type[hist_index[ivar]],hist_kind[topoindex]));
