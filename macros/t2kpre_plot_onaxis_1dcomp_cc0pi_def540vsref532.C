{
    ...
    TString neutversion = "NEUT, On-axis";
    ...
    pfile[1] = new TFile("basicplotsv8_neut532_card_5.3.6_nd2_C_GFGCCQErpa.root","READ");
    ...
    char *model_name[NMODEL2COMP]={"NEUT v5.4.0 default" ,"NEUT v5.3.2 (RFG+RPA)"};
    ...
    for ( int ivar = 0 ; ivar < NVAR2PLOT ; ivar++ ){
        ...
        h_1d_comprat[0][ivar]->GetYaxis()->SetTitle("MC/v540");
