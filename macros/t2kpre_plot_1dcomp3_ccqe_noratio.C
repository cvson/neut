{
    ...
    pfile[2] = new TFile("basicplotsv8_neut540_card_5.3.6_nd5_C_sfCCQE_ccqemec.root","READ");
    ...
    char *model_name[NMODEL2COMP]={"Relativistic Fermi Gas\0", "Local Fermi Gas\0","Spectral Function\0" };
    ...
    for ( int ivar = 0 ; ivar < NVAR2PLOT ; ivar++ ){
        ...
        c1->Print(Form("plots/%s_%s_%s_%s_3modelsnorat.eps",neutversion_s.Data(),flavor_str[flavorindex],hist_type[hist_index[ivar]],hist_kind[topoindex]));
