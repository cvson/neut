{
    ...
    TString neutversion = "NEUT v5.4.0, GS";
    ...
    pfile[2] = new TFile("basicplotsv7_neut540_card_5.4.0_nd5_C_1p1hCCQE_1piRS.root","READ");*/
     ...
     TString neutversion_s = "neut540";
     pfile[0] = new TFile("basicplotsv8add_neut540_card_5.3.6_nd5_C_1p1hCCQE_1pi.root","READ");
     pfile[1] = new TFile("basicplotsv8add_neut540_card_5.3.6_nd5_C_1p1hCCQE_1pi_offnucleff.root","READ");
    ...
    char *model_name[NMODEL2COMP]={"GS - Nuclear eff. ON\0" ,"GS - Nuclear eff. OFF\0"};
    ...
    for ( int ivar = 0 ; ivar < NVAR2PLOT ; ivar++ ){
        ...
        c1->Print(Form("plots/%s_%s_%s_%s_1piGS_nucleff.eps",neutversion_s.Data(),flavor_str[flavorindex],hist_type[hist_index[ivar]],hist_kind[topoindex]));
