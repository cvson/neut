{
    ...
    const Int_t NMODEL2COMP = 5;
    TFile *pfile[NMODEL2COMP];
    pfile[0] = new TFile("basicplotsv7_neut540_card_5.4.0_nd5_C_1p1hCCQE_default.root","READ");
    pfile[1] = new TFile("basicplotsv7_neut540_card_5.3.6_nd5_C_SFCCQE.root","READ");
    pfile[2] = new TFile("basicplotsv7_neut540_card_5.4.0_nd5_C_LFGCCQE.root","READ");
    pfile[3] = new TFile("basicplotsv7_neut540_card_5.4.0_nd5_C_LFGCCQE_RPA.root","READ");
    pfile[4] = new TFile("basicplotsv7_neut540_card_5.4.0_nd5_C_GFGCCQE.root","READ");
    
    char *model_name[NMODEL2COMP]={"1p1h Nieve\0" ,"SF\0"    ,"LFG\0", "LFG + RPA\0"  ,"GFG\0" };
    ...
    h_1d_comprat[0]->GetYaxis()->SetTitle("MC/1p1h");
    titleStyle2x(h_1d_comprat[0]);
    ...
    c1->Print(Form("plots/%s_%s_%s_%s_comp1d.eps",neutversion_s.Data(),flavor_str[flavorindex],hist_type[hist_index],hist_kind[topoindex]));
