{
    ...
    //For GFG
    new TCanvas;
    NEUT_bindEvsk_mode1->GetXaxis()->SetRangeUser(0,0.5);
    NEUT_bindEvsk_mode1->GetYaxis()->SetRangeUser(0,0.2);
    ...
    NEUT_bindEvsk_mode1->GetYaxis()->SetTitleOffset(1.8);
    ...
    leg0->Draw("same");
    l1->Draw();
    gPad->Print(Form("plots/%s_bindEvsk_%s_ccqe.eps",neutversion_s.Data(),modelname[0]));
