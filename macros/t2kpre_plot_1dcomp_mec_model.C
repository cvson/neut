{
    ...
    pfile[2] = new TFile("basicplotsv7_neut540_card_5.4.0_nd5_C_1p1hCCQE_1piRS.root","READ");*/
     ...
     pfile[1] = new TFile("basicplotsv8_neut540_card_5.3.6_nd5_C_SFCCQE_ccqemec.root","READ");
     pfile[2] = new TFile("basicplotsv8_neut540_card_5.3.6_nd5_C_GFGCCQE_ccqemec.root","READ");
    ...
    char *model_name[NMODEL2COMP]={"1p1h\0" ,"SF\0", "RFG\0" };
