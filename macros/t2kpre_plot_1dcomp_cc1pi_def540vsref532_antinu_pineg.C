{
    ...
    char *model_name[NMODEL2COMP]={"NEUT v5.4.0, GS 1#pi" ,"NEUT v5.3.2, GS 1#pi"};
    ...
    for ( int ivar = 0 ; ivar < NVAR2PLOT ; ivar++ ){
        ...
        c1->Print(Form("plots/%s_%s_%s_%sneg_def540vsref532.eps",neutversion_s.Data(),flavor_str[flavorindex],hist_type[hist_index[ivar]],hist_kind[topoindex]));
