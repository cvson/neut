{
    ...
    pfile[2] = new TFile("basicplotsv7_neut540_card_5.4.0_nd5_C_1p1hCCQE_1piRS.root","READ");*/
     ...
     pfile[1] = new TFile("basicplotsv8_neut540_card_5.3.6_nd5_C_1p1hCCQE_ccqemec_pf209.root","READ");
     pfile[2] = new TFile("basicplotsv8_neut540_card_5.3.6_nd5_C_1p1hCCQE_ccqemec_pf225.root","READ");
    ...
    char *model_name[NMODEL2COMP]={"1p1h-p_{F}=217 MeV\0" ,"1p1h-p_{F}=209 MeV\0", "1p1h-p_{F}=225 MeV\0" };
    ...
    for ( int ivar = 0 ; ivar < NVAR2PLOT ; ivar++ ){
        ...
        c1->Print(Form("plots/%s_%s_%s_%s_1p1hpf.eps",neutversion_s.Data(),flavor_str[flavorindex],hist_type[hist_index[ivar]],hist_kind[topoindex]));
