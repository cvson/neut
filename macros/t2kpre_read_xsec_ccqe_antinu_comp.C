...
void t2kpre_read_xsec_ccqe_antinu_comp(){
    gROOT->ProcessLine(".x rootlogon.C");
    gROOT->ProcessLine(".L basicPlotUtil.C");
    const Int_t NMODE4COMP = 3;
    TFile *pfile[NMODE4COMP];
    pfile[0] = new TFile("test_neut540kek_1p1hccqe_default.root","READ");
    pfile[1] = new TFile("test_neut540kek_sfccqe.root","READ");
    pfile[2] = new TFile("test_neut540kek_gfgccqe.root","READ");
    TString neutversion_s = "neut540";
    TString neutversion = "NEUT v5.4.0";
    TString subname = "comp3_nd2";
    
    char *modestr[NMODE4COMP]={"Nieve 1p1h","Spectral Function","Relativistic Fermi Gas"};
