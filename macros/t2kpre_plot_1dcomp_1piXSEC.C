{
   ...
   pfile[2] = new TFile("basicplotsv7_neut540_card_5.4.0_nd5_C_1p1hCCQE_1piRS.root","READ");
    ...
    TH1D *hflux[NMODEL2COMP];
    TH1D *hrat[NMODEL2COMP];
    ...
    /*int hist_index = 0;
    char *xtitle = "Neutrino Energy (GeV)";
     char *ytitle = "#frac{d#sigma}{dp_{E_{#nu}}} (x10^{-38}cm^{2})";
    double xminrange = 0.;
    double xmaxrange = 5.;//
    double xlegmin = 0.55;
    double ylegmin = 0.65;
    ...
    char *ytitle = "#frac{d#sigma}{dQ^{2}} (x10^{-38} cm^{2}.GeV^{-2})";
     double xminrange = 0.;
    ...
    char *ytitle = "#frac{d#sigma}{dp_{#mu^{-}}} (x10^{-38} cm^{2}.GeV^{-1})";
     double xminrange = 0.;
    double xmaxrange = 2.0;//
    double xlegmin = 0.55;
    double ylegmin = 0.65;
    ...
    char *ytitle = "#frac{d#sigma}{d cos #theta_{#mu}} (x10^{-38} cm^{2}.GeV^{-1})";
    double xminrange = -1;
    double xmaxrange = 1.;//
    double xlegmin = 0.55;
    double ylegmin = 0.65;
    ...
    char *ytitle = "#frac{d#sigma}{dW^{2}} (x10^{-38} cm^{2}.GeV^{-2})";
    double xminrange = 1.;
    double xmaxrange = 2.;//
    double xlegmin = 0.55;
    double ylegmin = 0.65;
    ...
    for ( int ifile = 0 ; ifile < NMODEL2COMP ; ifile++ ){//change to 11
        ...
        hflux[ifile] = (TH1D*)pfile[ifile]->Get("fluxhisto");
        hrat[ifile] = (TH1D*)pfile[ifile]->Get("ratehisto");
        double fluxweight = hflux[ifile]->GetSumOfWeights();
        double binwidth = (h_max[hist_index]-h_min[hist_index])/h_bins[hist_index];
        h_1d_comp[ifile]->Scale(12./(fluxweight*binwidth));
        //h_1d_comp[ifile]->Divide(hflux[ifile]);
        //h_1d_comp[ifile]->Scale(12.);//
    }
    ...
    c1->Print(Form("plots/%s_%s_%s_%s_compGSvsRSXSEC.eps",neutversion_s.Data(),flavor_str[flavorindex],hist_type[hist_index],hist_kind[topoindex]));
