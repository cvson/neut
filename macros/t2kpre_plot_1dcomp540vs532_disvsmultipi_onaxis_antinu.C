{
    ...
    TString neutversion_s = "neut_onaxis_540vs532";
    const Int_t NCHAN2COMP = 3;
    const Int_t NMODEL2COMP = 2;
    
    TFile *pfile[NMODEL2COMP];
    pfile[0] = new TFile("basicplotsv8add_neut540_antinu_card_5.3.6_nd2_C_1p1hCCQE_dis.root","READ");
    pfile[1] = new TFile("basicplotsv8add_neut532_antinu_card_5.3.6_nd2_C_GFGCCQE_dis.root","READ");
