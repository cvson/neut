{
    ...
    TString neutversion_s = "neut532vs540_ccqegfg";
    //no different GFGCCQE_v2 and GFGCCQE, only NEUT-EFVER is set to 0, but it's defaul
    pfile[0] = new TFile("basicplotsv8_neut540_card_5.3.6_nd5_C_GFGCCQE_ccqemec.root","READ");
    pfile[1] = new TFile("basicplotsv8_neut532_card_5.3.6_nd5_C_GFGCCQE_ccqemec.root","READ");
    ...
    char *model_name[NMODEL2COMP]={"GFG - v5.4.0\0" ,"GFG - v5.3.2\0"};
