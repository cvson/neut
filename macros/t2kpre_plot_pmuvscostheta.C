{
    ...
    TString neutversion1 = "NEUT v5.4.0, Nieve 1p1h,#nu_{#mu}";//no different in neut_3.6
    TString neutversion2 = "NEUT v5.4.0, 2p2h, #nu_{#mu}";
    
    TFile *pfile = new TFile("basicplotsv8_neut540_card_5.3.6_nd5_C_1p1hCCQE_ccqemec.root","READ");
    TH2D *NEUT_mu_cosanglevsp_mode1 = (TH2D*)pfile->Get("h_CCQE_coslepvsP_numu");
    TH2D *NEUT_mu_cosanglevsp_mode2 = (TH2D*)pfile->Get("h_CCMEC_coslepvsP_numu");
    ...
    l1->Draw();
    gPad->Print(Form("plots/%s_numu_cosanglevsp_CCQE.eps",neutversion_s.Data()));
    ...
    l2->Draw();
    gPad->Print(Form("plots/%s_numu_cosanglevsp_CCMEC.eps",neutversion_s.Data()));
