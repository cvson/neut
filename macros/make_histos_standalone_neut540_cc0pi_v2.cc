...
// Just run root -l make_histos_standalone_neut540_cc0pi_v2.cc("neut_input.root","neut_histo_output.root")
// Check that you have update the path and the file names in the 
// function make_histos_standalone_neut540_cc0pi_v2()
...
void make_histos_standalone_neut540_cc0pi_v2(char *in_fname, char *out_fname){
    //in 5.3.2 there is no neutnucfsivert.so and neutnucfsistep.so
    // gSystem->Load("/home/cvson/nuicise/neut/neut_5.3.2/src/neutclass/neutnucfsistep.so");
    //gSystem->Load("/home/cvson/nuicise/neut/neut_5.3.2/src/neutclass/neutnucfsivert.so");
    gSystem->Load("/home/cvson/nuicise/neut/neut_5.3.2/src/neutclass/neutvtx.so");
    gSystem->Load("/home/cvson/nuicise/neut/neut_5.3.2/src/neutclass/neutpart.so");
    gSystem->Load("/home/cvson/nuicise/neut/neut_5.3.2/src/neutclass/neutfsipart.so");
    gSystem->Load("/home/cvson/nuicise/neut/neut_5.3.2/src/neutclass/neutfsivert.so");
    gSystem->Load("/home/cvson/nuicise/neut/neut_5.3.2/src/neutclass/neutvect.so");
...
void fill_histos(char *in_fname, char *out_fname){  	
    ...
    //2D plots
    TH2D *NEUT_mu_pvscosangle = new TH2D("NEUT_mu_pvscosangle"," muon momentum vs. cos(angle)",100,0.,2.,100,-1.,1.);
    TH2D *NEUT_mu_cosanglevsp = new TH2D("NEUT_mu_cosanglevsp"," cos(angle) vs. muon momentum",100,-1.,1.,100,0.,2.);
    TH2D *NEUT_q0vsq3= new TH2D("NEUT_q0vsq3"," q0vsq3",120,0.,1.2,120,0.,1.2);
    TH2D *NEUT_q3vsq0= new TH2D("NEUT_q3vsq0"," q3vsq0",120,0.,1.2,120,0.,1.2);
    ...
    for ( Int_t j = 0 ; j < nevents ; j++ ){
        ...
        if (abs(nvect->Mode) <30){ // select  all CC interaction
            ...
            if(npion==0){
                ...
                NEUT_mu_pvscosangle->Fill(p_mu,cos_mu);//newadd
                NEUT_mu_cosanglevsp->Fill(cos_mu,p_mu);//newadd
    ...
    TH2D *NEUT_mu_pvscosangle_XS = (TH2D*)NEUT_mu_pvscosangle->Clone("NEUT_mu_pvscosangle_XS");
    NEUT_mu_pvscosangle_XS->Scale(norm_rate*50*50/nevents);
    
    TH2D *NEUT_mu_cosanglevsp_XS = (TH2D*)NEUT_mu_cosanglevsp->Clone("NEUT_mu_cosanglevsp_XS");
    NEUT_mu_cosanglevsp_XS->Scale(norm_rate*50*50/nevents);
    
    TH2D *NEUT_q0vsq3_XS = (TH2D*)NEUT_q0vsq3->Clone("NEUT_q0vsq3_XS");
    NEUT_q0vsq3_XS->Scale(norm_rate*100*100/nevents);
    
    TH2D *NEUT_q3vsq0_XS = (TH2D*)NEUT_q3vsq0->Clone("NEUT_q3vsq0_XS");
    NEUT_q3vsq0_XS->Scale(norm_rate*100*100/nevents);
