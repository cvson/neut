{
    ...
    TFile *pfile[NMODEL2COMP];
     ...
     TString neutversion_s = "onaxis_neut";

    
    pfile[0] = new TFile("basicplotsv8_neut540_antinu_card_5.4.0_nd2_C_1p1hCCQE_default.root","READ");
    pfile[1] = new TFile("basicplotsv8_neut532_antinu_card_5.3.6_nd2_C_GFGCCQErpa.root","READ");
    ...
    char *model_name[NMODEL2COMP]={"NEUT v5.4.0 default" ,"NEUT v5.3.2 default"};
