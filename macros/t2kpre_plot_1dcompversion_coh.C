{
    ...
    TString neutversion = "NEUT, RS model";
    ...
    TString neutversion_s = "neut";
    pfile[0] = new TFile("basicplotsv8add_neut540_card_5.3.6_nd5_C_1p1hCCQE_coh.root","READ");
    pfile[1] = new TFile("basicplotsv8_neut540_card_5.3.6_nd5_C_GFGCCQE_cohRS.root","READ");
    //pfile[1] = new TFile("basicplotsv8add_neut532_card_5.3.6_nd5_C_GFGCCQE_coh.root","READ");
    
    //pfile[1] = new TFile("basicplotsv8add_neut532_card_5.3.6_nd5_C_GFGCCQE_coh_fixfz.root","READ");
    ...
    char *model_name[NMODEL2COMP]={"NEUT v5.4.0\0", "NEUT v5.3.2\0"};
    ...
    */
    ...
    for ( int ivar = 0 ; ivar < NVAR2PLOT ; ivar++ ){
        ...
        c1->Print(Form("plots/%s_%s_%s_%s_compRS540vs532.eps",neutversion_s.Data(),flavor_str[flavorindex],hist_type[hist_index[ivar]],hist_kind[topoindex]));
