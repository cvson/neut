{
    ...
    pfile[1] = new TFile("basicplotsv8_neut540_antinu_card_5.3.6_nd5_C_1p1hCCQE_ccqemec_norescat.root","READ");
    ...
    char *model_name[NMODEL2COMP]={"1p1h w/ FSI" ,"1p1h wo/FSI"};
    ...
    for ( int ivar = 0 ; ivar < NVAR2PLOT ; ivar++ ){
        ...
        c1->Print(Form("plots/%s_%s_%s_%s_nonucscat.eps",neutversion_s.Data(),flavor_str[flavorindex],hist_type[hist_index[ivar]],hist_kind[topoindex]));
