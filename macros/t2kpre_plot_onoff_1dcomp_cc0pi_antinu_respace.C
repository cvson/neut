{
    ...
    bool IsAreaNormalization = false;
    
    pfile[0] = new TFile("basicplotsv8_neut540_antinu_card_5.4.0_nd2_C_1p1hCCQE_default_cc0pirespace.root","READ");
    pfile[1] = new TFile("basicplotsv8_neut540_antinu_card_5.4.0_nd5_C_1p1hCCQE_default_cc0pirespace.root","READ");
    pfile[2] = new TFile("basicplotsv8_neut532_antinu_card_5.3.6_nd2_C_GFGCCQErpa_cc0pirespace.root","READ");
    pfile[3] = new TFile("basicplotsv8_neut532_antinu_card_5.3.6_nd5_C_GFGCCQErpa_cc0pirespace.root","READ");
