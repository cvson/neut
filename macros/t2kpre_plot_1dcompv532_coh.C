{
    ...
    TString neutversion_s = "neut532vs540_cohRS";
    const Int_t NMODEL2COMP = 2;
    TFile *pfile[NMODEL2COMP];
    pfile[0] = new TFile("basicplotsv7_neut540_card_5.4.0_nd5_C_1p1hCCQE_1piRS_SFCCQE_RSCOH.root","READ");
    //pfile[0] = new TFile("basicplotsv7_neut540_card_5.4.0_nd5_C_1p1hCCQE_1piRS.root","READ");
