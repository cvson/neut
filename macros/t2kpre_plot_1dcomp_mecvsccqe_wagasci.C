{
    ...
    TString neutversion_s = "wagasci_neut540";
    const Int_t NCHAN2COMP = 3;
    TFile *pfile;
    pfile = new TFile("basicplotsv9_neut540_card_5.3.6_wagasci_C_1p1hCCQE_ccqemec.root","READ");
    ...
    int topoindex[NCHAN2COMP] = {1,3,2};//DIS and multi pion
    ...
    hist_index[15]= 35;//muon momentum
    xtitle[15]= "2nd Highest energy proton P_{n} (GeV)";
    xminrange[15]= 0;
    xmaxrange[15]= 2;//
    xlegmin[15]= 0.55;
    ylegmin[15]= 0.45;
    ...
    hist_index[16]= 34;//muon momentum
    xtitle[16]= "Highest energy proton cos #theta_{n}";
    xminrange[16]= -1;
    xmaxrange[16]= 1;//
    xlegmin[16]= 0.55;
    ylegmin[16]= 0.45;
    ...
    hist_index[17]= 36;//muon momentum
    xtitle[17]= "2nd Highest energy proton cos #theta_{n}";
    xminrange[17]= -1;
    xmaxrange[17]= 1;//
    xlegmin[17]= 0.55;
    ylegmin[17]= 0.45;
    ...
    hist_index[18]= 37;//muon momentum
    xtitle[18]= "Opening angle btw two highest energy protons";
    xminrange[18]= -1;
    xmaxrange[18]= 1;//
    xlegmin[18]= 0.55;
    ylegmin[18]= 0.45;
