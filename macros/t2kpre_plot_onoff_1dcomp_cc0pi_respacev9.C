{
    ...
    pfile[0] = new TFile("basicplotsv9_neut540_card_5.4.0_nd2_C_1p1hCCQE_default_cc0pirespace.root","READ");
    pfile[1] = new TFile("basicplotsv9_neut540_card_5.4.0_nd5_C_1p1hCCQE_default_cc0pirespace.root","READ");
    pfile[2] = new TFile("basicplotsv9_neut532_card_5.3.6_nd2_C_GFGCCQErpa_cc0pirespace.root","READ");
    pfile[3] = new TFile("basicplotsv9_neut532_card_5.3.6_nd5_C_GFGCCQErpa_cc0pirespace.root","READ");
    ...
    char *model_name[NMODEL2COMP]={"On-axis, #nu_{#mu} v5.4.0" ,"Off-axis, #nu_{#mu} v5.4.0","On-axis, #nu_{#mu} v5.3.2" ,"Off-axis, #nu_{#mu} v5.3.2"};
    ...
    //basic_histos_v9topo_resphace.cc
    //phasesphace restric
    ...
    //ymaxscale[1]= 1.5;
    ymaxscale[1]= 1.511;
    if(IsAreaNormalization && topoindex==5) ymaxscale[1]= 2.011;
    ...
    ylegmin[8]= 0.45;
    ymaxscale[8]= 1.511;
        if(IsAreaNormalization && topoindex==5) ymaxscale[8]= 2.011;
