...
basic_histos(char *fname,char *fname_out)
{
    ...
    for ( nev = 0 ; nev < nevents ; nev++ ){
        ...
        if ( isCCdis21(mode) ){
            ...
            //fill_nproton_hist(h_combined[3][21][ip_idx],rate_norm,nproton); //For DIS, nproton is replaced with No. of primary pion
            fill_npion_hist(h_combined[3][22][ip_idx],rate_norm,npion);
            fill_out_dispiINI_hist(nvect,h_combined[3][27][ip_idx],h_combined[3][28][ip_idx],h_combined[3][21][ip_idx],h_2d_combined[3][6][ip_idx],rate_norm);
            //ingore 31 32 index for TH1
            fill_out_dispiFSI_hist(nvect,h_combined[3][29][ip_idx],h_combined[3][30][ip_idx],h_2d_combined[3][7][ip_idx],rate_norm);
        }
        if ( isCCdis26(mode) ){
            ...
            //fill_nproton_hist(h_combined[4][21][ip_idx],rate_norm,nproton); //For DIS, nproton is replaced with No. of primary pion
            fill_npion_hist(h_combined[4][22][ip_idx],rate_norm,npion);
            fill_out_dispiINI_hist(nvect,h_combined[4][27][ip_idx],h_combined[4][28][ip_idx],h_combined[4][21][ip_idx],h_2d_combined[4][6][ip_idx],rate_norm);
            //ingore 31 32 index for TH1
            fill_out_dispiFSI_hist(nvect,h_combined[4][29][ip_idx],h_combined[4][30][ip_idx],h_2d_combined[4][7][ip_idx],rate_norm);
        }
        if ( isCC1pi(mode) ){
