...
basic_histos(char *fname,char *fname_out)
{
    ...
    for ( nev = 0 ; nev < nevents ; nev++ ){
        ...
        if ( isCCtopo0pi(npion,mode) && leptonmon<1.0 && leptoncosangle>0.64279 && protonmon>0.450 && nproton==1 ){
        ...
        if ( isCCtopo0pi(npion,mode)&& leptonmon<1.0 && leptoncosangle>0.64279 && protonmon>0.450  ){
        ...
        if ( isCCtopo0pi(npion,mode) && leptonmon<1.0 ){
        ...
        if ( isCCtopo0pi(npion,mode) && leptoncosangle>0.64279){
        ...
        if ( isCCtopo0pi(npion,mode) && leptonmon<1.0 && leptoncosangle>0.64279 ){
