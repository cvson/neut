void titleStyle2x(TH1* h1, double scalefactor){
    h1->SetTitle("");
    h1->GetYaxis()->CenterTitle();
    h1->GetXaxis()->CenterTitle();
    h1->GetXaxis()->SetLabelSize(h1->GetXaxis()->GetLabelSize()*scalefactor);
    h1->GetYaxis()->SetLabelSize(h1->GetYaxis()->GetLabelSize()*scalefactor);
    h1->GetXaxis()->SetTitleSize(h1->GetXaxis()->GetTitleSize()*scalefactor);
    h1->GetYaxis()->SetTitleSize(h1->GetYaxis()->GetTitleSize()*scalefactor);
