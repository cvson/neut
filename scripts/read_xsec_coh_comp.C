...
void read_xsec_coh_comp(){
    gROOT->ProcessLine(".x rootlogon.C");
    gROOT->ProcessLine(".L basicPlotUtil.C");
    const Int_t NMODE4COMP = 2;
    TFile *pfile[NMODE4COMP];
    pfile[0] = new TFile("/home/cvson/nuicise/neut/neut_5.4.0/src/neutsmpl/test_xsec_cccoh_rs_nd5.root","READ");
    pfile[1] = new TFile("/home/cvson/nuicise/neut/neut_5.4.0/src/neutsmpl/test_xsec_cccoh_bs_nd5.root","READ");
    TString neutversion_s = "neut540";
    TString neutversion = "NEUT v5.4.0";
    TString subname = "comp2modecoh";
    
    char *modestr[NMODE4COMP]={"Rein-Seghal","Berger-Seghal"};
