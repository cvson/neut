void plot_basics_comp2ver_mec(){
    ...
    /*TFile *ffile = new TFile(ipDir4+"basicplotso_5.3.6_nd5_C_GFGCCQE_mec.root");
    TString vername = "NEUT 5.4.0"; 
    TFile *ffile2 = new TFile(ipDir1+"basicplotso_5.3.6_nd5_C_GFGCCQE_mec.root");
    TString vername2 = "NEUT 5.3.6";
    TString savename ="nd5_mec_gfg_neut540vs536_";*/
 
    TFile *ffile = new TFile(ipDir4+"basicplotso_5.3.6_nd5_C_SFCCQE_mec.root");
    TString vername = "NEUT 5.4.0"; 
    TFile *ffile2 = new TFile(ipDir1+"basicplotso_5.3.6_nd5_C_SFCCQE_mec.root");
    TString vername2 = "NEUT 5.3.6";
    TString savename ="nd5_mec_sf_neut540vs536_";	
