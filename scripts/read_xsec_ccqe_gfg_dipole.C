...
void read_xsec_ccqe_gfg_dipole(){
    ...
    pfile[0] = new TFile("/home/cvson/nuicise/neut/neut_5.4.0/src/neutsmpl/test_xsec_v536_nd5_C_gfgccqe_dipole.root","READ");
    pfile[1] = new TFile("/home/cvson/nuicise/neut/neut_5.4.0/src/neutsmpl/test_xsec_v536_nd5_C_gfgccqe_bbba05.root","READ");
    pfile[2] = new TFile("/home/cvson/nuicise/neut/neut_5.4.0/src/neutsmpl/test_xsec_v536_nd5_C_gfgccqe_bbba07.root","READ");
    ...
    TString subname = "ccqe_gfg_dipole";
    
    char *modestr[NMODE4COMP]={"Dipole, M_{A}^{QE} = 1.21 GeV/c^{2}","BBBA05, M_{A}^{QE} = 1.21 GeV/c^{2}", "BBBA07, M_{A}^{QE} = 1.21 GeV/c^{2}"};
