{
    ...
    pfile[0] = new TFile("basicplotsv7_neut540_card_5.4.0_nd5_C_LFGCCQE.root","READ");
    pfile[1] = new TFile("basicplotsv7_neut540_card_5.4.0_nd5_C_LFGCCQE_RPA.root","READ");

    
    char *model_name[NMODEL2COMP]={"LFG\0", "LFG + RPA\0"};
    ...
    c1->Print(Form("plots/%s_%s_%s_%s_rpa.eps",neutversion_s.Data(),flavor_str[flavorindex],hist_type[hist_index],hist_kind[topoindex]));
