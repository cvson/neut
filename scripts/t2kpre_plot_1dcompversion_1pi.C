{
    ...
    //pfile[0] = new TFile("basicplotsv7_neut540_card_5.4.0_nd5_C_GFGCCQE.root","READ");
    //pfile[1] = new TFile("basicplotsv7_neut532_card_5.3.6_nd5_C_GFGCCQE.root","READ");
    ...
    char *model_name[NMODEL2COMP]={"GS - v5.4.0\0" ,"GS - v5.3.2\0"};
