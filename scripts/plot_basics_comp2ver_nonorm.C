void plot_basics_comp2ver_nonorm(){
    ...
    /*TFile *ffile = new TFile(ipDir+"basicplot_nonorm_540_nd2_ch_MDLQE402_ALL.root");
    TString vername = "NEUT 5.4.0, Spec. Func."; 
    TFile *ffile2 = new TFile(ipDir+"basicplot_nonorm_540_nd2_ch_MDLQE02_ALL.root");
    TString vername2 = "NEUT 5.4.0, Fermi G.";
    TString savename ="nd2_v540nonorm_mdlqe402_vs02_";
	*/
   /* TFile *ffile = new TFile(ipDir+"basicplot_nonorm_540_nd2_ch_MDLQE402_ALL.root");
    TString vername = "NEUT 5.4.0, Graczyk-Sobczyk"; 
    TFile *ffile2 = new TFile(ipDir+"basicplot_nonorm_540_nd2_ch_MDLQE402_RS4pi_ALL.root");
    TString vername2 = "NEUT 5.4.0, Rein-Seghal";
    TString savename ="nd2_v540nonorm_mdlqe402_gsvsrs_";*/
 
    /*TFile *ffile = new TFile(ipDir+"basicplot_nonorm_540_nd2_ch_MDLQE402_RS4pi_ALL.root");
    TString vername = "NEUT 5.4.0, Rein-Seghal"; 
    TFile *ffile2 = new TFile(ipDir+"basicplot_nonorm_540_nd2_ch_MDLQE402_RS4pi20piless_ALL.root");
    TString vername2 = "NEUT 5.4.0, Rein-Seghal, 20%PDD";
    TString savename ="nd2_v540nonorm_mdlqe402_RS4pi_piless_";*/


    TFile *ffile = new TFile(ipDir+"basicplot_nonorm_532_nd2_ch_MDLQE402_RS4pi_ALL.root");
    TString vername = "NEUT 5.3.2, Rein-Seghal"; 
    TFile *ffile2 = new TFile(ipDir+"basicplot_nonorm_532_nd2_ch_MDLQE402_RS4pi20piless_ALL.root");
    TString vername2 = "NEUT 5.3.2, Rein-Seghal, 20%PDD";
    TString savename ="nd2_v532nonorm_mdlqe402_RS4pi_piless_";
