void plot_basics_comp3ver_cc0pi(){
    ...
    TFile *ffile = new TFile(ipDir4+"basicplotso_5.4.0_nd5_C_CC0pi_MDLQE2002.root");
    TString vername = "Nieve 1p1h"; 
    TFile *ffile2 = new TFile(ipDir4+"basicplotso_5.4.0_nd5_C_CC0pi_MDLQE402.root");
    TString vername2 = "Spectral Func.";
   TFile *ffile1 = new TFile(ipDir4+"basicplotso_5.4.0_nd5_C_CC0pi_MDLQE02.root");
    TString vername1 = "Fermi gas";
    TString savename ="neut540_nd5_cc0pi_comp3_";
